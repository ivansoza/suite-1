...
if ($("#pageWrapper").hasClass("compact-wrapper")) {
  ...
  $(".submenu-content").hide();
    ...
    $(".sidebar-title").on("click", function () {
      console.log("Hiciste clic en un sidebar-title");
      console.log("Están activos antes del clic:", $(".sidebar-title.active").length);
  
      // Primero, resetea todo a su estado inicial
      $(".sidebar-title").removeClass("active");
      $(".sidebar-submenu").removeClass("close-submenu").slideUp("normal");
      $(".sidebar-submenu, .submenu-wrapper").slideUp("normal");
      $(".submenu-wrapper").slideUp("normal");
  
      // Abre el submenú asociado al título clickeado y todos sus submenús anidados
      if ($(this).next().is(":hidden") == true) {
        console.log("El elemento siguiente estaba oculto, ahora se mostrará.");
  
        $(this).addClass("active");
        $(this).next().slideDown("normal", function() {
          // Una vez que el primer nivel se ha desplegado, abre todos los niveles anidados
          $(this).find(".sidebar-menu").addClass("active");
          $(this).find(".submenu-wrapper").slideDown("normal");
        });
        $(".sidebar-wrapper").removeClass("sidebar-default");
        $(".page-header").removeClass("sidebar-default");
        console.log("Estado después de activar:", $(this).hasClass("active"));
      }
    });
    ...
    // Maneja los clics en los títulos de submenús
    $(".submenu-title").on("click", function () {
      $(".submenu-title")
        .removeClass("active")
        .find("div")
    ...
    $(".submenu-content").hide(); // Asegúrate de que el contenido del submenú esté oculto inicialmente
  }
